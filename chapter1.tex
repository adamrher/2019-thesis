...
Chapter~\ref{sec:chapter6} contains a convergence study of CAM6 using the CAM-SE dynamical core, with a new dry mass vertical coordinate \citep{LetAl2018JAMES}, a Conservative Semi-Lagrangian Advection Method for tracer advection \citep[CSLAM; ][]{LTOUNGK2017MWR}, and the physics are evaluated on the CSLAM grid \citep{HL2018MWR}. Table~\ref{tbl:table1-6} shows the results of a convergence study in an aqua-planet configuration \citep[`QOBS' SST profile in][]{NH2000ASL}.
