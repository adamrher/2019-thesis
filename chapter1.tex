...
The main findings of $\sim$30 years of convergence studies of the NCAR's climate model lineage can be summarized as follows. In every convergence study reviewed, and where the data are available:
...
\noindent These observations form the general rules of thumb of how the model has historically responded to resolution. 
